        ...
        <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-300">
          ...
          <span className="font-medium">
            {Math.round(skills.reduce((acc, skill) => {
              const customValue = skill.name === 'Excel/PPT/Word' ? 95 :
                                 skill.name === 'AI智能体' ? 75 :
                                 skill.name === '机场运维管理' ? 70 :
                                 skill.name === '沟通协调' ? 75 :
                                 skill.name === '学习研究' ? 90 : null;
              
              if (customValue !== null) {
                return acc + customValue;
              }
              
              const levelValues = { expert: 95, proficient: 75, good: 70, beginner: 40 };
